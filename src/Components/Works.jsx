...
const Works = () => {
  return (
    <div className="text-white px-5 py-2 relative">
      ...
      <div
        className="absolute bottom-10 right-10 w-96 h-96 bg-gradient-to-r from-blue-500/18 to-cyan-500/22 rounded-full blur-3xl animate-pulse-glow"
      ...
      <div className="flex flex-col gap-5 relative z-10">
        <div className="w-full flex py-5 px-2 md:px-5 flex-col lg:flex-row gap-6 lg:gap-8">
          <div className="flex w-full lg:w-[35%] items-center gap-0 justify-center lg:justify-start">
            ...
            >
              <h1
                className={`${turrent.className} text-2xl bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent`}
              >
                Experience
              </h1>
            ...
            <div
              className={`${turrent.className} flex flex-col gap-6 lg:gap-9 pt-6 lg:pt-30 ml-4 lg:ml-6`}
            >
              <motion.div
                variants={fading(1.5)}
                viewport={{ once: true }}
                initial="initial"
                whileInView="after"
                className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-xl"
              >
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-0 right-0 p-0.5 blur-border-2xl rounded-[7px] flex items-center justify-center w-[58px] h-[37px] animate-gradient-border">
                <Link
                  href="https://janakripan-c-portfolio.vercel.app/"
                  target="_blank"
            ...
            >
              <div className="p-2 text-black flex flex-col gap-3 card">
                ...
                />
                <p className="text-justify leading-relaxed">
                  Developed a website for client Hexa Productions as part of my
                  work. Designed and developed the website as per client
                  requirements.
                </p>
              ...
              <div className="absolute bottom-0 right-0 p-0.5 blur-border-2xl rounded-[7px] flex items-center justify-center w-[58px] h-[37px] animate-gradient-border">
                <Link
                  href={"https://hexa-production-mu.vercel.app/#home"}
                  target="_blank"
                  className="bg-black z-10 cursor-pointer w-full h-full rounded-[7px] flex items-center justify-center "
                  title="view"
                >
            ...
            >
              <div className="p-2 text-black flex flex-col gap-3 card">
                ...
                />
                <p className="text-justify leading-relaxed">
                  developed a architecture website ui as part of my learning
                  journey, which is dark themed , using modern ui design with
                  smooth animations.
                </p>
              ...
              <div className="absolute bottom-0 right-0 p-0.5 blur-border-2xl rounded-[7px] flex items-center justify-center w-[58px] h-[37px] animate-gradient-border">
                <Link
                  href={"https://blog-website-frontend-p34u.onrender.com/login"}
                  target="_blank"
                  className="bg-black z-10 cursor-pointer w-full h-full rounded-[7px] flex items-center justify-center "
                  title="view"
                >
        ...
        <motion.div
          ...
          whileInView="after"
          viewport={{ once: true }}
          className="px-6 md:px-14 py-8 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-3xl border border-white/10 shadow-2xl mx-4 relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            <h2
              className={`${turrent.className} text-3xl mb-6 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent text-center`}
            >
            ...
            <ol className="list-decimal list-inside leading-relaxed space-y-3 text-gray-200">
              <li className="hover:text-white transition-colors duration-300">
                ...
                Learn HTML, CSS, and JavaScript. Focus on building simple pages
                first.
              </li>
              <li className="hover:text-white transition-colors duration-300">
                ...
                I chose the MERN stack and Next.js for modern, full-stack
              ...
              <li className="hover:text-white transition-colors duration-300">
                ...
                Apply what you learn by building practical apps and modern UI
                concepts. My work at Scanntek IT Solutions taught me a lot.
              </li>
              <li className="hover:text-white transition-colors duration-300">
                <strong className="text-green-400">Gain Experience:</strong>{" "}
                Transition from personal projects to internships and full-time
                roles, just like my journey at Scanntek IT Solutions.
              </li>
              <li className="hover:text-white transition-colors duration-300">
                <strong className="text-pink-400">Keep Improving:</strong> Read
                docs, experiment with new libraries, and follow dev communities.
                Stay curious and build consistently.
              </li>
            </ol>
            <p className="mt-6 italic text-center bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent backdrop-blur-sm bg-white/5 rounded-2xl p-4 border border-white/10">
              Everyone's path is different. This is what worked for me — and I'm

...
const Home = () => {
  ...
  return (
    <div className="text-white flex flex-col sm:flex-row lg:min-h-screen relative pt-14 home-container">
      ...
      <div
        className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-purple-500/20 to-pink-500/25 rounded-full blur-3xl animate-pulse-glow"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-cyan-500/15 to-blue-500/20 rounded-full blur-3xl animate-pulse-glow"
      ...
      <div
        className="absolute bottom-40 left-20 w-52 h-52 bg-gradient-to-r from-violet-500/15 to-purple-400/20 rounded-full blur-2xl animate-float"
        style={{ animationDelay: "3s" }}
      ></div>

      <div className="sm:w-1/2 w-full flex flex-col justify-center gap-6 px-6 py-10 relative z-10 text-section">
        <motion.div
          variants={leftFadeIn(-50, 0.5)}
          initial="initial"
          whileInView="after"
          viewport={{ once: true }}
        ...
        >
          <h1
            className={`${underdog.className} text-2xl flex items-center gap-2`}
          >
            Hi There{" "}
        ...
        <div className={`${underdog.className} text-2xl font-bold w-full`}>
          ...
          >
            ...
            <div className="title-container">
              <p
                className={`text-2xl title-text whitespace-nowrap ${desig.className}`}
              >
                SOFTWARE
              </p>
              <motion.div
        ...
        <div
          className={`hidden sm:block pt-6 text-base sm:text-xl text-justify leading-relaxed max-w-3xl ${underdog.className} backdrop-blur-sm bg-white/5 rounded-2xl p-6 border border-white/10 shadow-2xl`}
        >
          <motion.p
            variants={leftFadeIn(-190, 1.8)}
            initial="initial"
            whileInView="after"
            viewport={{ once: true }}
          >
            Welcome! I'm Janakripan, a passionate Software Developer from
            Thalassery, Kerala. My core expertise lies in building highly
            interactive, modern front-end experiences using React and Next.js.
            Additionally, I have strong foundational knowledge in back-end
            development with Node.js and Express.js, allowing me to integrate
            seamlessly across the full stack.
          </motion.p>
          <div className="flex flex-col gap-1 items-center justify-center pt-5 text-3xl font-bold">
            <motion.p
              variants={rightFadeIn(500, 2)}
              initial="initial"
              whileInView="after"
              viewport={{ once: true }}
              className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-yellow-400 to-green-500 font-bold text-xl"
            >
              I'm Available on
            </motion.p>
            <motion.div
            ...
            >
              <CircleTextIcon
                ...
                url="https://www.linkedin.com/in/janakripan-c"
              />
              <CircleTextIcon
      ...
      <div
        className={`block sm:hidden px-6 pb-10 text-base text-justify leading-relaxed ${underdog.className} relative z-10 backdrop-blur-sm bg-white/5 rounded-2xl mx-6 p-6 border border-white/10`}
      >
        <p>
          I'm Janakripan, a passionate Software Developer from Thalassery,
          Kerala. I specialize in crafting exceptional user interfaces with
          React and Next.js, backed by a solid understanding of server-side
          development using Node.js and Express.js.
        </p>
        <div className="flex flex-col gap-1 items-center justify-center pt-5 text-3xl font-bold">
          <motion.p
            variants={rightFadeIn(100, 1)}
            initial="initial"
            whileInView="after"
            viewport={{ once: true }}
            className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-yellow-400 to-green-500 font-bold text-xl"

...
const About = () => {
  ...
  return (
    <section className="flex flex-col gap-5 text-white py-5 px-6 md:px-20 relative">
      ...
      <div
        className="absolute bottom-10 left-10 w-80 h-80 bg-gradient-to-r from-blue-500/20 to-cyan-500/25 rounded-full blur-3xl animate-pulse-glow"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-stretch relative z-10">
        ...
        <motion.div
          ...
          initial="initial"
          whileInView="after"
          className="lg:col-span-2 flex flex-col justify-center bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-md rounded-2xl p-8 text-gray-100 shadow-2xl border border-white/10 relative overflow-hidden"
        >
          ...
          >
            ...
            scalable web applications with highly intuitive user interfaces. My
            primary expertise is rooted in modern front-end ecosystems,
            particularly React and Next.js. Beyond the client side, I am
            well-versed in back-end technologies like Node.js and Express.js,
            enabling me to design and consume APIs effectively and deliver
            complete, seamless digital solutions.
          </p>
        </motion.div>
        ...
        <div className="lg:col-span-1 flex flex-col gap-3 h-full">
          <motion.div
            ...
            whileInView="animate"
            viewport={{ once: true }}
            className="w-full shrink-0 h-14 bg-gradient-to-br from-amber-400 to-amber-600 rounded-xl shadow-md flex items-center justify-center text-4xl font-bold text-white"
          >
            <span>👨‍💻</span>
          </motion.div>
          <motion.div
          ...
          >
            <div className="text-black w-full h-full p-5 flex justify-center flex-col gap-3 resume-card">
              ...
              >
                ...
                employers. Make it compelling, well-structured, and tailored to
            ...
            <a href="/janakripan-cv-new-updated.pdf" target="_blank">
      ...
      <motion.div
        ...
        whileInView="after"
        viewport={{ once: true }}
        className={`w-full p-8 flex flex-col gap-4 justify-center rounded-3xl relative bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-md border border-white/10 shadow-2xl overflow-hidden`}
      >
        ...
        <h1
          className={`${aw.className} text-3xl self-center bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent relative z-10`}
        >
          My Skills
        </h1>
        <p
          className={`${tinos.className} self-center text-center relative z-10 text-gray-200`}
        >
          Here are the technologies and tools I work with — always learning,
          always improving to build smarter, stronger solutions.
        </p>
        {!skillList ? (
        ...
        <button
          className={`absolute flex items-center justify-center rounded-full border-4 border-black bottom-2.5 left-1/2 transform -translate-x-1/2 w-auto px-2 h-[30px] bg-gradient-to-r from-gray-600 via-blue-900 cursor-pointer ${head.className}`}
